...
$list = $infoclient->infoclient($_SESSION["idclient"]);
...
<!--<a href="package.php">Aller à la liste </a>-->
    <hr>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>123 Street, Ghazela, Ariana, Tunisia</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+216 00345 689</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>tunistyle@gmail.com</small>
                </div>
            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="index_.php" class="nav-item nav-link">Home</a>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">123 Street, Ghazela , Ariana, Tunisia</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">tunistyle@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="travel-agency-html-template\Contact-us neeeeewww1.png"
                ...
                <form action="" method="POST" onsubmit="return validateForm()">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <?php
        foreach ($list as $infoclient) {
        ?>  
                                
                                
                                <div class="ms-3">
                            <h5 class="text-primary">Nom client</h5>
                           
                        </div>
                                
                                <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" value =<?PHP echo $infoclient['name']; ?> >
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+216 00345 689</p>
