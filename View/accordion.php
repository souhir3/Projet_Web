                            ...
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius" src="assets/images/IMG_molka.jpg" alt="Generic placeholder image">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Update Reponse</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Update Reponse</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<body>
    <a href="bs-basic-table.php">Aller à la liste</a>
    <hr>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="emailrep" id="emailrep" value="<?php echo $reponse['emailrep'] ,'disabled'; ?>" maxlength="20" ></td>
                </tr>
