            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Update Reclamation</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                                <li class="breadcrumb-item text-white active" aria-current="page">Update Reclamation</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Update Reclamation</h6>
            </div>
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td ><?php echo $reclamation['name']; ?> <input type="hidden" name="name" id="name" value="<?php echo $reclamation['name']; ?>"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td> <?php echo $reclamation['email']; ?><input type="hidden" name="email" id="email" value="<?php echo $reclamation['email']; ?>" maxlength="20"></td>
                </tr>
