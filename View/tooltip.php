                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body" >
                                        <div class="row">
                                        <form action="" method="POST" >                                            <div class="col-sm-12">
                                                    ...
                                                    <div class="card-block tooltip-icon button-list">
                                                       ...
                                                       <label for="message"></label>
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="number" name="idrec" class="form-control" id="idrec" placeholder="IDreclamation">
                                                            <label for="name"></label>
                                                        </div>
                                                        <div class="input-group">
                                                            <span class="input-group-prepend" id="name"><label class="input-group-text"><i class="icofont icofont-ui-email"></i></label></span>
                                                            <input type="text" id="emailrep" name="emailrep" class="form-control" placeholder="Enter email" title="Enter email" data-toggle="tooltip">
                                                        </div>
